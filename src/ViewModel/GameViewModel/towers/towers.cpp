...
None::None(Position position_) {
    ...
    position = position_;
    total_price = 0;
    animations[0].actions.push_back(Action(ActionType::UpgradeTower,UpgradeTowerParams{id,TowerType::Archer1, 70}));
    animations[0].actions.push_back(Action(ActionType::UpgradeTower,UpgradeTowerParams{id,TowerType::Engineer1, 125}));
...
Engineer1::Engineer1(Position position_, int total_price_) {
    ...
    position = position_;
    total_price = total_price_;
    animations.push_back(Animation(State::Idle,"terrain_artillery_0001",Position{0.0f, 15.0f},true));
    ...
    animations[0].actions.push_back(Action(ActionType::UpgradeTower,UpgradeTowerParams{id,TowerType::Engineer2, 220}));
    animations[0].actions.push_back(Action(ActionType::SellTower,UpgradeTowerParams{id,TowerType::None, -total_price}));
...
Engineer2::Engineer2(Position position_, int total_price_) {
    ...
    position = position_;
    total_price = total_price_;
    animations.push_back(Animation(State::Idle,"terrain_artillery_0002",Position{0.0f, 15.0f},true));
    ...
    animations[0].actions.push_back(Action(ActionType::UpgradeTower,UpgradeTowerParams{id,TowerType::Engineer3, 320}));
    animations[0].actions.push_back(Action(ActionType::SellTower,UpgradeTowerParams{id,TowerType::None, -total_price}));
...
Engineer3::Engineer3(Position position_, int total_price_) {
    ...
    position = position_;
    total_price = total_price_;
    animations.push_back(Animation(State::Idle,"terrain_artillery_0003",Position{0.0f, 15.0f},true));
    ...
    animations[0].actions.push_back(Action(ActionType::SellTower,UpgradeTowerParams{id,TowerType::None, -total_price}));
    ranged.attacks.push_back(RangedAttack(2.5, 180.0, BulletType::Bomb, 67.2, 50.0, "bombs_0003", 1.0)); // 添加攻击
...
Mage2::Mage2(Position position_, int total_price_) {
    ...
    animations.push_back(Animation(State::Idle,"shootermage",Position{0.0f, 57.0f}));
    animations[0].actions.push_back(Action(ActionType::UpgradeTower,UpgradeTowerParams{id,TowerType::Mage3, 240}));
    animations[0].actions.push_back(Action(ActionType::SellTower,UpgradeTowerParams{id,TowerType::None, -total_price}));
